...
import io.github.autumnaldev.limleg.module.eternal_frost.item.tool.*;
...
public class ToolRegistryEF extends GenericRegistry<Item> {
    ...
    public static final Item ARCTITE_SWORD = INSTANCE.add("arctite_sword", new ArctiteSwordItem());
    public static final Item ARCTITE_SHOVEL = INSTANCE.add("arctite_shovel", new ArctiteShovelItem());
    public static final Item ARCTITE_PICKAXE = INSTANCE.add("arctite_pickaxe", new ArctitePickaxeItem());
    public static final Item ARCTITE_AXE = INSTANCE.add("arctite_axe", new ArctiteAxeItem());
    public static final Item ARCTITE_HOE = INSTANCE.add("arctite_hoe", new ArctiteHoeItem());
